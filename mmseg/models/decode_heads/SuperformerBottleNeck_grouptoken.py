...
class SuperformerBottleNeck(BaseDecodeHead):
    def __init__(
        ...
        merge_pos: Sequence[int] = (0,4,7,10,),
...
**kwargs)
        ...
        for i, (depth, dim, head, sp_size, sp_head, stride) in enumerate(
            ...
            self.use_pixel_classification = ( self.classification_feature == 'pixel' or  self.classification_feature == 'combined')
            ...
            stages.append(
                SuperformerStage(
                    ...
                    mergelayer=merge_layer,
                    merge_pos = merge_pos[i],

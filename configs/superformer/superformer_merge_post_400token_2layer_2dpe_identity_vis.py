...
model = dict(
    ...
    decode_head=dict(
        ...
        sp_iter=2,
        num_group_tokens = (1600,1600,),
        num_output_groups = (1600,1600,),
        group_token_init_methods=("identity","identity",),
        group_token_embedding_method=("fourier","fourier",),
        token_strides =(2,0,),
        token_channels_list=(192,192,),
        depths_merge = (4,4,),
        merge_heads = (6,6,),
        hard_assignment = (False,False,),
        vis_token = 'all_groups',
        output_dir = '/root/autodl-tmp/superformer_merge_post_400token_2layer_2dpe_identity',
        vis_featuremap = True,
        vis_sp_logits = True,

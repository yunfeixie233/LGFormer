...
model = dict(
    ...
    vis_gt = True,
    vis_gt_eff = True,
    output_dir = '/data2/yunfei/superformer_baseline_voc12aug-480x480_adam_cross_2stage_sim_pred_resize_final_added_small_pre_1group_p8_nols_avg3_loss_6h_vis_2',
    loss_decode=[
            dict(

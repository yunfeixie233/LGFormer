...
model = dict(
    ...
    decode_head=dict(
        ...
        sp_iter=2,
        num_group_tokens = (64,64,64,),
        num_output_groups = (64,64,),
        group_token_init_methods=("learnable","learnable","learnable",),
        group_token_embedding_method=("learnable","learnable","learnable",),
        token_strides =(4,4,4,),
        token_channels_list=(384,384,384,),
        depths_merge = (6,6,6,),
        merge_heads = (6,6,6,),
        ...
        vis_sp_logits = False,
        group_projector_from_sp_feature=False,

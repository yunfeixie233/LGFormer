...
model = dict(
    ...
    decode_head=dict(
        ...
        sp_iter=2,
        merge_methods="GPViT_mix",
        merge_pos = (0,4,7,10,),
        group_projector_methonds ='cross',
        use_middle_pixel_features = True,
        classification_feature = 'pixel',
        vis_token = 'all_groups',
        output_dir = '/data2/yunfei/superformer_gpvit_mix_12_proj_2stage_cross_mid_2',
...
optim_wrapper = dict(
    ...
    type='OptimWrapper',
    optimizer=dict(
        type='AdamW', lr=3.5e-5, betas=(0.9, 0.999), weight_decay=0.1),
    paramwise_cfg=dict(

...
model = dict(
    ...
    vis_sp = True,
    vis_gt = True,
    output_dir = '/data2/yunfei/superformer_baseline_ade20k-512x512_adam_cross_2stage_sim_pred_resize_final_added_pre_2group_p68_nols_conv48_noallls_vis_micro_',
    arch_settings = {
        'embed_dims': 384,
        'patch_size': 8,
        'window_size': 2,
